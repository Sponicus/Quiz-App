...
VALUE ('name1', 'username1', 'email1', 'password1'), ('name2', 'username2', 'email2', 'password2'), ('name3', 'username3', 'email3', 'password3'), ('name4', 'username4', 'email4', 'password4'), ('name5', 'username5', 'email5', 'password5');

INSERT INTO catagories (name, description)
VALUE ('Math', 'This catagory is comprised of quizzes that are focused around a mathematical solution'), ('Trivia', 'This category is comprised of quizzes that are focused around popular culture trivia');

INSERT INTO quizzes (catagory_id, name, description, is_private,creator_id)
VALUE (1,'Math for dummies', 'simple math', false,2), (2, 'Trivia for dummies','simple trivia', true, 5);
